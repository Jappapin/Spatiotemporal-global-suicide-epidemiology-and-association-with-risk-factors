...
year_int <- data$year
# id for association
data$x1_id <- data$country_year
data$x3_id <- data$country_year
data$x6_id <- data$country_year
data$x7_id <- data$country_year
data$x13_id <- data$country_year
data$x16_id <- data$country_year
data$x18_id <- data$country_year
data$x19_id <- data$country_year
data$x26_id <- data$country_year
data$x33_id <- data$country_year
