...
year_int <- data$year
# id for association
data$x1_id <- data$year
data$x3_id <- data$year
data$x6_id <- data$year
data$x7_id <- data$year
data$x13_id <- data$year
data$x16_id <- data$year
data$x18_id <- data$year
data$x19_id <- data$year
data$x26_id <- data$year
data$x33_id <- data$year
